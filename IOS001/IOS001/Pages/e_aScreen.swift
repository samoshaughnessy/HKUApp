        ...
        ScrollView{
            ...
            VStack(alignment:.leading){
                ...
                HStack{
                    ...
                    Spacer()
                    Text("提出覆核申請需要提交哪些資料？ ▼").lineLimit(3).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center).foregroundColor(.white).onTapGesture {
                        tapped = !tapped
                    }
                    Spacer()
                }
