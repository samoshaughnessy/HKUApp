        ...
        ScrollView{
            ...
            VStack(alignment:.leading){
                ...
                HStack{
                    ...
                    Spacer()
                    Text("精神健康覆核審裁（MHRT) ▼").lineLimit(3).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center).foregroundColor(.black).onTapGesture {
                        tapped = !tapped
                    }
                    Spacer()
                }
