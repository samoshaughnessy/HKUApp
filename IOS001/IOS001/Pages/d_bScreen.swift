        ...
        ScrollView{
            ...
            VStack(alignment:.leading){
                ...
                HStack{
                    ...
                    Spacer()
                    Text("精神健康覆核審裁（MHRT) ▼").lineLimit(3).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center).foregroundColor(.white).onTapGesture {
                        tapped = !tapped
                    }
                    Spacer()
                }
                ...
                Text("\n精神健康覆核審裁（MHRT)").lineLimit(4).font(Font.system(size: 30)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center)
                ...
                Text("\n聯絡精神健康覆核審裁處").lineLimit(3).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center)
                ...
                Text("精神健康覆核審裁處香港添馬添美道2號政府總部東翼19樓\n").lineLimit(6).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center)
                ...
                Link("+852 2594 5636", destination: URL(string: "tel:+85225945636")!).lineLimit(2).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center)
                
                Link("https://www.healthbureau.gov.hk/cn/committees/mhrt.htm", destination: URL(string: "https://www.healthbureau.gov.hk/cn/committees/mhrt.htm")!).lineLimit(6).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center)
