        ...
        ScrollView{
            ...
            VStack(alignment:.leading){
                ...
                HStack{
                    ...
                    Spacer()
                    Text("進入中途宿舍需要哪些條件？").lineLimit(3).font(Font.system(size: 25)).fontWeight(.bold).frame(maxWidth: .infinity).multilineTextAlignment(.center).foregroundColor(.white).onTapGesture {
                        tapped = !tapped
                    }
                    Spacer()
                }
