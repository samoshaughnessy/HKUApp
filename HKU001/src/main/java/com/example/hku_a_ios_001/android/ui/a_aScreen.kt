...
fun A_aScreen(
    ...
    Column(
        ...
        modifier = Modifier.background(color = md_theme_light_background),
//        horizontalAlignment = Alignment.CenterHorizontally,
        ) {

        Text("什麼是有條\n" +
                "件釋放？", lineHeight = 50.sp, fontSize = 40.sp, fontWeight = FontWeight.Bold,
        )
        Text("相比於無條件釋放，有條件釋放令要求您出院後遵守一些特定的條件，如果您未遵守這些條件，而院長認為基於您的健康或安全，或為保護他人著想而有需要有可能將您重新召回精神病院。\n" +
                "\n")
        Text("相關條例")
        Text(" 《精神健康條例》（第136章）\n" +
                "第42B條",fontWeight = FontWeight.Bold ) // Bold
        ...
        Row (
            ...
            Button(
                modifier = Modifier.weight(1f).height(30.dp).then(Modifier.width(30.dp)),
                enabled = true,
                onClick = onNextButtonClicked
            ) {
                Text(stringResource(com.example.hku_a_ios_001.android.R.string.next))
            }
